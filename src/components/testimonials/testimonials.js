  ...
  return (
    <>
      <div className="main-container">
        <FontAwesomeIcon onClick={handlePrev} icon={faArrowLeft} />
        <div className="each-test">
          <a href={testimonials[id]?.link}>linkedin</a>
          <h4>{testimonials[id]?.name}</h4>
          <h6>{testimonials[id]?.role}</h6>
          <h6>{testimonials[id]?.test}</h6>
        </div>
